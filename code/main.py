...
S3_DATA_INPUT_PATH="s3://s3emr-athena-sripad/source-folder/wikiticker-2015-09-12-sampled.json"
S3_DATA_OUTPUT_PATH_FILTERED="s3://s3emr-athena-sripad/data-output/filtered"

def main():
    spark = SparkSession.builder.appName('projectDemo').getOrCreate()
